...
static const struct of_device_id g_gpufreq_mfg2_of_match[] = {
	{ .compatible = "mediatek,mt6785-mfg2",},
	{ .compatible = "mediatek,mfg2",},
	{}
};
static const struct of_device_id g_gpufreq_mfg3_of_match[] = {
	{ .compatible = "mediatek,mt6785-mfg3",},
	{ .compatible = "mediatek,mfg3",},
	{}
};
static const struct of_device_id g_gpufreq_mfg5_of_match[] = {
	{ .compatible = "mediatek,mt6785-mfg5",},
	{ .compatible = "mediatek,mfg5",},
	{}
};
...
unsigned int mt_gpufreq_get_shader_present(void)
{
	...
	switch (segment_id) {
	case MT6785U_SEGMENT:
		shader_present = MT_GPU_SHADER_PRESENT_3;
		break;
	case MT6785T_SEGMENT:
		shader_present = MT_GPU_SHADER_PRESENT_3;
		break;
...
static void __mt_gpufreq_init_table(void)
{
	...
	if (segment_id == MT6785U_SEGMENT)
		g_segment_max_opp_idx = 20;
	else if (segment_id == MT6785T_SEGMENT)
